...
// actually happened.
//
//   npm run review:clips                              # into docs/reviews/clips/
//   npm run review:clips -- --only=3                  # just clip 3, while iterating
//   npm run review:clips -- --seed=99                 # a different series seed
//
// The full set is thirteen clips and takes a while in real time; the three
// HUD-hidden pairings (`--only=1`, `--only=4`, `--only=7`) are the recommended
// subset when a full pass is not needed.
//
